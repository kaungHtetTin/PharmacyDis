...
const officePages = [...officeNav.map(([key]) => key), 'login', 'profile', 'pharmacies-detail', 'product-detail', 'representatives-detail', 'inventory-detail', 'invoice-detail', 'order-detail', 'payable-detail', 'payment-detail', 'receiving-detail', 'stock-transfer-create', 'stock-transfer-detail'];
...
export default function Root() {
    ...
    return (
        <OfficeLayout
            activePage={page === 'stock-transfer-create' || page === 'stock-transfer-detail' ? 'stock-transfers' : page === 'inventory-detail' ? 'inventory' : page === 'invoice-detail' ? 'invoices' : page === 'order-detail' ? 'orders' : page === 'payable-detail' ? 'payables' : page === 'payment-detail' ? 'payments' : page === 'product-detail' ? 'products' : page === 'receiving-detail' ? 'receiving' : page === 'representatives-detail' || page === 'pharmacies-detail' ? page.replace('-detail', '') : page}
        ...
        >
            ...
            {officeAccessAllowed && page !== 'dashboard' && page !== 'pharmacies-detail' && page !== 'representatives-detail' && page !== 'invoice-detail' && page !== 'order-detail' && page !== 'payable-detail' && page !== 'payment-detail' && page !== 'product-detail' && page !== 'receiving-detail' && page !== 'stock-transfer-detail' && page !== 'profile' && page !== 'users' && page !== 'activity-logs' && (
